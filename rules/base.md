...
- 모호한 부분은 추측하지 말고 사용자에게 먼저 질문할 것
- AskUserQuestion/request_user_input 같은 질문 도구를 사용할 수 있으면 도구를 사용하고, 사용할 수 없으면 텍스트로 질문할 것
