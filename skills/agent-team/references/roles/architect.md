...
- `stage gate` 전에 `workflow-runtime.md`의 Architectural Design 및 Task Plan 최소 검증 기준을 대조한다. 누락 항목은 설계나 Task Plan에 보완하고, 도메인 판단이 필요한 항목은 가정 또는 Domain Expert 검토 대상으로 표시한다.
